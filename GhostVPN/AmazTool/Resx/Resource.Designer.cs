...
namespace AmazTool.Resx {
    ...
    internal class Resource {
        ...
        /// <summary>
        ///   查找类似 Failed to terminate the GhostVPN. Close it manually, or the upgrade may fail. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Start GhostVPN, please wait... 的本地化字符串。
        /// </summary>
        internal static string RestartGhostVPN {
            get {
                return ResourceManager.GetString("RestartGhostVPN", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Try to terminate the GhostVPN process... 的本地化字符串。
        /// </summary>
