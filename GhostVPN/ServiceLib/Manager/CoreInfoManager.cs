...
public sealed class CoreInfoManager
{
    ...
    {
        var urlN = GetCoreUrl(ECoreType.GhostVPN);
        ...
        [
            new CoreInfo
                {
                    CoreType = ECoreType.GhostVPN,
                    Url = GetCoreUrl(ECoreType.GhostVPN),
                    ReleaseApiUrl = urlN.Replace(Global.GithubUrl, Global.GithubApiUrl),
                    DownloadUrlWin64 = urlN + "/download/{0}/GhostVPN-windows-64.zip",
                    DownloadUrlWinArm64 = urlN + "/download/{0}/GhostVPN-windows-arm64.zip",
                    DownloadUrlLinux64 = urlN + "/download/{0}/GhostVPN-linux-64.zip",
                    DownloadUrlLinuxArm64 = urlN + "/download/{0}/GhostVPN-linux-arm64.zip",
                    DownloadUrlOSX64 = urlN + "/download/{0}/GhostVPN-macos-64.zip",
                    DownloadUrlOSXArm64 = urlN + "/download/{0}/GhostVPN-macos-arm64.zip",
                },
