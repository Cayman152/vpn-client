...
public class Utils
{
    ...
    public static string StartupPath()
    {
        ...
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "GhostVPN");
        }
    ...
    public static bool IsPackagedInstall()
    {
        try
        {
            ...
            if (p.StartsWith("/opt/GhostVPN", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }

            if (p.StartsWith("/usr/lib/GhostVPN", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }

            if (p.StartsWith("/usr/share/GhostVPN", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }
        }
