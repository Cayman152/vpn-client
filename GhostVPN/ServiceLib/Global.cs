...
public class Global
{
    ...
    public const string SingboxRulesetUrl = @"https://raw.githubusercontent.com/runetfreedom/russia-v2ray-rules-dat/release/sing-box/rule-set-{0}/{1}.srs";
    ...
    public const string AutoRunName = "GhostVPNAutoRun";
    ...
    public const string AvaAssets = "avares://GhostVPN/Assets/";
    public const string LocalAppData = "GHOSTVPN_LOCAL_APPLICATION_DATA_V2";
    ...
    [
        "",
        @"https://raw.githubusercontent.com/runetfreedom/russia-v2ray-custom-routing-list/main/GhostVPN/template.json",
        @"https://raw.githubusercontent.com/Chocolate4U/Iran-v2ray-rules/main/GhostVPN/template.json"
    ];

    public static readonly List<string> DNSTemplateSources =
    [
        "",
        @"https://raw.githubusercontent.com/runetfreedom/russia-v2ray-custom-routing-list/main/GhostVPN/",
        @"https://raw.githubusercontent.com/Chocolate4U/Iran-v2ray-rules/main/GhostVPN/"
    ];
